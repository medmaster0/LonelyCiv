...
vector<string> street_monickers_pre = {"Mista", "Lil", "Supa", "Fitty", "Champ", "Kid", "Wiz", "Babyface","Cousin", "Filthy","Trashcan","Janky","Muthafucka"};
...
vector<string> animals = {"cow","pig","cat","elephant","dodo bird","unicorn","alligator","crocodile","liger","lion","tiger","dragon","gorilla","ostrich","monkey",
    "eagle","phoenix","sea bass","goat","sheep","horse","lizard","komodo dragon","gopher","prairie dawg","sloth","baboon","finch","newt","chicken","phesant","spider"
};
...
{16, 122, 176},
    ...
    {208, 254, 29},
    {255, 166, 43},{1, 180, 76},
    {255, 108, 181},    {107, 66, 71},
    {199, 193, 12},    {183, 255, 250},
    {174, 255, 110},    {236, 45, 1},
    {118, 255, 123},    {115, 0, 57},
    {4, 3, 72},    {223, 78, 200},
    {110, 203, 60},    {143, 152, 5},
    {94, 220, 31},    {217, 79, 245},
    {200, 253, 61},
    {7, 13, 13},    {73, 132, 184},
    {81, 183, 59},    {172, 126, 4},
    {78, 84, 129},    {135, 110, 75},
    {88, 188, 8},    {47, 239, 16},
    {45, 254, 84},    {10, 255, 2},
    {156, 239, 67},
    {24, 209, 123},
    ...
    {0, 2, 46},
    {130, 131, 68},
    {255, 197, 203},{171, 18, 57},
    {176, 5, 75},{153, 204, 4},{147, 124, 0},{1, 149, 41},{239, 29, 231},
    {0, 4, 53},
    {66, 179, 149},{157, 87, 131},
    {200, 172, 169},{200, 118, 6},{170, 39, 4},
    {228, 203, 255},{250, 66, 36},{8, 4, 249},
    {92, 178, 0},{118, 66, 78},{108, 122, 14},{251, 221, 126},
    {42, 1, 52},{4, 74, 5},
    {253, 70, 89},
    {13, 117, 248},{254, 0, 2},{203, 157, 6},{251, 125, 7},{185, 204, 129},{237, 200, 255},{97, 225, 96},{138, 184, 254},{146, 10, 78},
    {254, 2, 162},{154, 48, 1},
    {101, 254, 8},{190, 253, 183},{177, 114, 97},    {136, 95, 1},
    {2, 204, 254},{193, 253, 149},{131, 101, 57},{251, 41, 67},{132, 183, 1},{182, 99, 37},
    {127, 81, 18},{95, 160, 82},{109, 237, 253},{11, 249, 234},{199, 96, 255},{255, 255, 203},{246, 206, 252},{21, 80, 132},
    {245, 5, 79},{100, 84, 3},{122, 89, 1},{168, 181, 4},{61, 153, 115},{0, 1, 51},{118, 169, 115},{46, 90, 136},{11, 247, 125},{189, 108, 72},
    {172, 29, 184},{43, 175, 106},{38, 247, 253},
    {174, 253, 108},{155, 143, 85},{255, 173, 1},{198, 156, 4},
    {244, 208, 84},{222, 157, 172},{5, 72, 13},{201, 174, 116},{96, 70, 15},{152, 246, 176},{138, 241, 254},
    {46, 232, 187},
    {17, 135, 93},{253, 176, 192},{177, 96, 2},
    {247, 2, 42},{213, 171, 9},{134, 119, 95},{198, 159, 89},
    {122, 104, 127},{4, 46, 96},{200, 141, 148},{165, 251, 213},{255, 254, 113},
    {98, 65, 199},
    {255, 254, 64},{211, 73, 78},
    {152, 94, 43},
    {166, 129, 76},{255, 8, 232},
    {157, 118, 81},
    {254, 255, 202},
    {152, 86, 141},
    {158, 0, 58},
...
vector<string> publication_types =
{
    "Times", "Gazette", "Post", "Newsletter", "Daily", "Digest", "Newspaper", "Journal", "Bulletin"
};
