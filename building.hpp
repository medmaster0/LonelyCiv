...
void build_circle_radius(vector<vector<Item>>* map_scenery_top, bool* block_map, int map_width, int radius, int cent_x, int cent_y, SDL_Color p_col_in = {static_cast<Uint8>(rand()%255),static_cast<Uint8>(rand()%255),static_cast<Uint8>(rand()%255),255}, SDL_Color s_col_in = {0,0,0,255}); //Builds a circular structure of bricks
void build_circle_radius_door(vector<vector<Item>>* map_scenery_top, bool* block_map, int map_width, int radius, int cent_x, int cent_y, SDL_Color p_col_in = {static_cast<Uint8>(rand()%255),static_cast<Uint8>(rand()%255),static_cast<Uint8>(rand()%255),255}, SDL_Color s_col_in = {0,0,0,255}, SDL_Color door_col1 = {static_cast<Uint8>(rand()%255),static_cast<Uint8>(rand()%255),static_cast<Uint8>(rand()%255),255}); //Builds a circular structure of bricks
...
bool is_circle_clear(bool* block_map, int map_width, int map_height, int x, int y, int r); //checks the block map to make sure nothing is blocking the circl
