...
vector<vector<int>> A_star(bool block_map[],int map_width, int x1, int y1, int x2, int y2); //An even better A*, gash damn! not reliant on vector (but will return one for convenience)
