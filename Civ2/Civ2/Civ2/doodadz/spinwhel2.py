...
def spindleGen():
	...
	for i in range(0,10): #for each line
		...
		#the span of the radius 
		#LEFT SIDE
		for k in range(0, radius2+1): #for each point away from center along radius
			pixelMap[5-k, 10+i] = (255,255,255,255)

		#Now generate a new radius
		radius = radius + random.randint(-2,2)
		radius2 = radius2 + random.randint(-2,2)
	...
	#im.show()
	#im.save("spinwhel32_seco.png","PNG")
