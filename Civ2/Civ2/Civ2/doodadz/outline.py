...
def outlineFile(filename):
	...
	for i in range(0,32): #spans Y
		for j in range(0,32): #spans X

			#Change transparent on top of white to black 
			if i <31: #bounds checking
...
outlineFile("Civ2/Civ2/doodadz/screwpressSeco.png")
outlineFile("Civ2/Civ2/doodadz/spinwhelSeco.png")
