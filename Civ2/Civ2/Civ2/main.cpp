...
//        world_colors[i] = temp_col;
    ...
    tent_tiles_p[1] = loadTexture("Civ2/Civ2/tiles/tent1Prim.png");
    tent_tiles_s[1] = loadTexture("Civ2/Civ2/tiles/tent1Seco_alt.png");
}
...
//    }
    ...
    Tent temp_tent = Tent(tempx, tempy, (rand()%2), {static_cast<Uint8>(127+rand()%127), static_cast<Uint8>(127+rand()%127), static_cast<Uint8>(127+rand()%127), 255},{static_cast<Uint8>(127+rand()%127), static_cast<Uint8>(127+rand()%127), static_cast<Uint8>(127+rand()%127),255});
...
int main( int argc, char* args[] ){
    ...
    //while(true){
        vector<vector<int>> path_test = A_star(block_map,map_width, 5, 5, 13, 5);
                    ...
                    case SDLK_d:
                        ...
                        for(int i = 0; i < map_items[(cre1->y*map_width)+cre1->x+1].size(); i++){
                            if(map_items[(cre1->y*map_width)+cre1->x+1][i].type == 304){
                                printf("%d->meansblocked", map_items[(cre1->y*map_width)+cre1->x+1][i].type);
                                //willMove = false;
                                break;
                            }
                        }
